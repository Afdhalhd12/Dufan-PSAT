...
<div class="container-fluid position-relative mb-4" data-aos="fade-up"
        ...
        <div class="row position-relative" style="margin-left: 30px; z-index: 2;">
            <h1 class="fw-bold text-light d-flex justify-content-center align-items-center" style="margin-top: 60px">Kontak</h1>
            <p class="text-light text-center">Apakah Anda memiliki pertanyaan atau ingin berkonsultasi dengan tim kami? Jangan ragu untuk menghubungi kami.</p>
        </div>
    </div>
    ...
    <div class="d-flex">
        ...
        <div class="card mb-5 bg bg-primary rounded" style="max-width: 500px; height: 400px; margin-left: 110px; padding: 20px;" data-aos="fade-up">
        ...
        <!-- Card Form Kontak -->
        <div class="card" style="width: 800px; height: 400px; margin-left: 50px; padding: 20px; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.219);" data-aos="fade-up">
            <form>
                <div class="d-flex">
                <div class="mb-3 w-50">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" style="height: 100px" class="form-control" id="exampleInputPesan">
                </div>
